...
def get_gemini_response(messages, model=MODEL_NAME, vision=False, file_data=None, file_type=None, system_instruction=None):
    # Initialize the model natively supporting system instructions if provided
    ...
    if vision and file_data:
        ...
        # Correctly format history for the Google GenAI SDK
        formatted_history = []
        # Exclude the last message because we pass it to send_message()
